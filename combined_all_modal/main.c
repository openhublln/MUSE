...
int main(int argc, char *argv[]) {
    pthread_t thread_camera, thread_radar, thread_lidar;
    ...
    snprintf(LIDAR_DIR,sizeof(LIDAR_DIR),"%s/lidar/", output_dir);
    ...
    pthread_join(thread_lidar, NULL);
