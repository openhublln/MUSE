...
def parse_packet(packet):
    ...
    #packet_info['arrival_time'] = packet.sniff_time
...
def main():
    ...
    # 定义保存图像的路径
    output_directory = os.path.expanduser('~/DopplerMap')  # 替换为你想要保存的目录路径
    ...
    for pkt in tcp_packets:
        ...
        if parsed_data['header'] == 'RADC' and len(pkt) == 76:
            ...
            if len(radc_data) == 786432:
                ...
                output_filename = os.path.join(output_directory, f'{parsed_data["seq"]}.jpg')
